            ...
            <div class="form-group">
                ...
                <div class="form-group input-group">
                    <div class = "col">
                        ...
                        <button type="button" id = "update_uncheckpoi" class="btn btn-danger" style="width:28%;">Зберегти зміни</button>
                    </div>
                </div>
                ...
                <div class="form-group input-group">
                    <div class = "col">
                        <!-- <button type="button" id = "delete_poi" class="btn btn-danger">Видалити мітку</button> -->
                        <button type="button" id = "accept_uncheckpoi" class="btn btn-info" style="width:28%;">Прийняти мітку</button>
                    </div>
                </div>
    </form>
</div><!-- end .container-->
...
<script>
    ...
    /*function searchPlace() {
        ...
        document.getElementById("accept_uncheckpoi").addEventListener("click", accept_uncheckpoi);
        document.getElementById("update_uncheckpoi").addEventListener("click", update_uncheckpoi);
